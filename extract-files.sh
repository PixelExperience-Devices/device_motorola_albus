...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib/libcamerabgprocservice.so)
            ...
            ;;
        vendor/lib/libmmcamera_vstab_module.so|vendor/lib/libmmcamera_ppeiscore.so|vendor/lib/libmmcamera2_stats_modules.so|vendor/lib/libjscore.so|vendor/lib/libjscore.so)
